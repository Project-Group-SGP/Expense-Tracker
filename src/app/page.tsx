...
const testimonials = [
  {
    name: "Dhruv Kotadiya",
    quote: "Spendwise has completely transformed how I manage my finances!",
  },
  {
    name: "Ayush Kalathiya",
    quote:
      "I've never been so aware of my spending habits. Highly recommended!",
  },
  {
    name: "Sarthak Mayani",
    quote:
      "The insights provided by Spendwise are invaluable. It's a game-changer!",
  },
]
        ...
        <section className="px-3 pt-28 md:px-0 lg:px-0">
          <div className="flex flex-col-reverse items-center justify-between gap-12 pt-10 md:flex-row">
            <div className="max-w-xl">
              <h1 className="text-5xl font-bold leading-tight tracking-tight text-gray-900 dark:text-white md:text-6xl">
              ...
              <div className="mt-4 text-lg text-gray-700 dark:text-gray-400">
