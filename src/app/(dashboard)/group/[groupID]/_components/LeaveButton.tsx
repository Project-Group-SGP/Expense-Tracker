...
// export default function LeaveButton({ status, amount, userId, groupId, createrId }: LeaveButtonProps) {
...
//       setIsLoading(true)
//       const loading = toast.loading(isCreator ? "Deleting group..." : "Leaving group...", {
...
//         if (result.error) {
//           toast.error(isCreator ? "Failed to delete the group. Please try again." : "Failed to leave the group. Please try again.", {
//             closeButton: true,
//             id: loading
//           })
//           console.error(result.error)
//         } else {
//           toast.success(isCreator ? "You have successfully deleted the group." : "You have successfully left the group.", {
//             closeButton: true,
//             id: loading
//           })
...
//         description: 'This action cannot be undone. All group information and activities will be permanently deleted.',
//         action: 'Yes, delete group',
...
//             >
//               {isCreator ? <Trash2 className="w-4 h-4 mr-2" /> : <LogOut className="w-4 h-4 mr-2" />}
//               {isCreator ? 'Delete Group' : 'Leave Group'}
//             </Button>
//           </TooltipTrigger>
//           <TooltipContent>
//             <p>{isCreator ? 'Delete this group' : status === 'settled up' ? 'Leave this group' : 'Settle up before leaving'}</p>
//           </TooltipContent>
//         </Tooltip>
//       </TooltipProvider>
...
export default function LeaveButton({ status, amount, userId, groupId, createrId }: LeaveButtonProps) {
  ...
  return (
    <>
      ...
      <AlertDialog open={isAlertOpen} onOpenChange={setIsAlertOpen}>
        <AlertDialogContent className='max-w-[90vw] sm:max-w-lg w-full p-4 sm:p-6'>
          <AlertDialogHeader>
          ...
          <AlertDialogFooter className="flex-col sm:flex-row gap-2 sm:gap-0 mt-4 sm:mt-0">
            <AlertDialogCancel disabled={isLoading} className="w-full sm:w-auto mb-2 sm:mb-0">Cancel</AlertDialogCancel>
            <AlertDialogAction
              onClick={handleAction}
              className={cn(
