    ...
    >
      <Form {...form}>
        ...
        >
          ...
          {!showTwoFactor && <>
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="xyz@gmail.com" {...field} disabled={isPending} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}  
              ...
              <FormItem>
                ...
                <FormControl>
                  <div className="relative ">
                    <Input placeholder="Enter you Password" {...field} disabled={isPending} type={isPasswordVisible?'text':'password'}/>
                ...
                <Button
            disabled={isPending}
            className="px-0 pt-2 font-normal mt-[-10px] h-0"
            variant={"link"}
            size={"sm"}
            asChild
          >
          ...
          >
            {isPending?<Loader2 className="mr-2 h-4 w-4 animate-spin" />:<Mail className="mr-2 h-4 w-4" />} {showTwoFactor ? "Confirm" :"Login with Mail" }
          </Button>
        </form>
      </Form>
    </CardWrapper>
